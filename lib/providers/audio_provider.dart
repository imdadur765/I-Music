// lib/providers/audio_provider.dart - COMPLETELY FIXED
import 'dart:async';
...
// ✅ FIXED: Processing state provider - Now returns ProcessingState
final processingStateProvider = StreamProvider<ProcessingState>((ref) {
  final audioHandler = ref.watch(audioHandlerProvider);
  return audioHandler.processingStateStream;
});

// ✅ FIXED: Player state provider - Now returns PlayerState
